...
def final_plan():
    ...
    # Alternatives for a distance of 21K
        ...
        week_3 = [rest(),resistance(30),fartlek(6),hills(3),run(5),rest(),interval(13)]
        ...
        week_6 = [rest(),hills(2),speed(6),resistance(45),sprints(4),rest(),race(10)]
        ...
        week_3 = [rest(),resistance(45),tempo(15),hills(4),tempo(5),rest(),tempo(30)]
        ...
        week_6 = [rest(),hills(2),progression(18),resistance(30),sprints(10),rest(),race(25)]
